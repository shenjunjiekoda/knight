...
template < typename Num, DomainKind Kind, DomainKind SepKind >
IntervalDom< Num, Kind, SepKind >::LinearConstraintSystem
IntervalDom< Num, Kind, SepKind >::within_interval(const LinearExpr& expr,
...
void IntervalSolver< Num, NumericalDom >::add(LinearConstraintSystemRef csts) {
    for (const LinearConstraint& cst : csts.get().get_linear_constraints()) {
...
bool IntervalSolver< Num, NumericalDom >::refine_to_numerical(
    Var x, const Interval& itv, NumericalDom& numerical) {
...
template < typename Num, typename NumericalDom >
IntervalSolver< Num, NumericalDom >::Interval
IntervalSolver< Num, NumericalDom >::compute_residual(
    const LinearConstraint& cst, Var pivot, const NumericalDom& numerical) {
...
template < typename Num, typename NumericalDom >
bool IntervalSolver< Num, NumericalDom >::propagate(const LinearConstraint& cst,
                                                    NumericalDom& numerical) {
