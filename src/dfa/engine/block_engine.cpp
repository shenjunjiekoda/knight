...
/// list.
void BlockEngine::exec_cxx_ctor_initializer(
...
/// begin transfer.
void BlockEngine::exec_scope_begin(StmtRef trigger_stmt, VarDeclRef var_decl) {
    // todo
}

/// \brief Transfer endding of a scope implicitly generated by
/// the compiler after the last Stmt in a CompoundStmt's body
void BlockEngine::exec_scope_end(StmtRef trigger_stmt, VarDeclRef var_decl) {
    // todo
}

/// \brief Transfer C++ new allocator call
void BlockEngine::exec_new_allocator_call(const clang::CXXNewExpr* expr) {
    // todo
}

/// \brief Transfer the point where the lifetime of an automatic object ends
void BlockEngine::exec_lifetime_ends(StmtRef trigger_stmt,
                                     VarDeclRef var_decl) {
    // todo
}

/// \brief Transfer the stmt
ProgramStateRef BlockEngine::exec_cfg_stmt(StmtRef stmt,
