...
AnalysisManager::AnalysisManager(KnightContext& ctx) : m_ctx(ctx) {
    m_sym_mgr =
        std::make_unique< analyzer::SymbolManager >(m_ctx.get_allocator());
    m_region_mgr =
        std::make_unique< analyzer::RegionManager >(m_ctx.get_allocator());
    m_state_mgr =
        std::make_unique< analyzer::ProgramStateManager >(*this,
                                                          *m_region_mgr,
                                                          *m_sym_mgr,
                                                          m_ctx
                                                              .get_allocator());
...
analyzer::ProgramStateManager& AnalysisManager::get_state_manager() const {
    return *m_state_mgr;
}

analyzer::SymbolManager& AnalysisManager::get_symbol_manager() const {
    return *m_sym_mgr;
}
