...
template <>
struct IntrusiveRefCntPtrInfo< const knight::analyzer::ProgramState > {
    static void retain(const knight::analyzer::ProgramState* state) {
        knight::analyzer::retain_state(state);
    }
    static void release(const knight::analyzer::ProgramState* state) {
        knight::analyzer::release_state(state);
    }
