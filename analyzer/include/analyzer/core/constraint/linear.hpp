...
/// Variable.
template <>
struct DenseMapInfo< knight::analyzer::ZVariable > {
    // NOLINTNEXTLINE
    static inline knight::analyzer::ZVariable getEmptyKey() {
        uintptr_t x = reinterpret_cast< uintptr_t >(
                          DenseMapInfo< void* >::getEmptyKey()) &
                      ~0x7; // NOLINT
        return knight::analyzer::ZVariable(
            reinterpret_cast< knight::analyzer::SymbolRef >(x));
    }

    // NOLINTNEXTLINE
    static inline knight::analyzer::ZVariable getTombstoneKey() {
        uintptr_t x = reinterpret_cast< uintptr_t >(
    ...
    // NOLINTNEXTLINE
    static unsigned getHashValue(const knight::analyzer::ZVariable& zvar) {
    ...
    // NOLINTNEXTLINE
    static bool isEqual(const knight::analyzer::ZVariable& lhs,
                        const knight::analyzer::ZVariable& rhs) {
...
class LinearConstraint : public llvm::FoldingSetNode {
  public:
    ...
    using LinearExpr = knight::analyzer::LinearExpr< Num >;
    using Var = Variable< Num >;
